...
docker secret ls
```
- Only services and containers assigned to the secrets have access
...
docker exec -it psql.1.cscswefwf bash 

# ls /run/secrets/ 

# cat /run/secrets/psql_user
```
- `docker service update --secret-rm` - removing a secret. Causes restarting a container.
...
```
echo "efefewfewf" | docker secret create psql-pw -
